    ...
    <main className="archive-shell">
      ...
      <header className="archive-header">
        <a href="#top" className="mark" aria-label="D—CONSTRUCT home">
          <img src={asset('logo.gif')} alt="디자인대학을 해체시키는 시선" />
        </a>
      ...
      <section className="archive-board" id="top">
        <section className="visual-field" aria-label="Elevator deconstruction study">
          <div className="visual-heading">
            <p>OBJECT / ELEVATOR</p>
            <h1><img src={asset('logo-stay.png')} alt="디자인대학을 해체시키는 시선" /></h1>
          </div>
          ...
          >
            {view === 3 ? (
              <div className="footage" onMouseEnter={playFootage} onMouseLeave={stopFootage}>
                <video
                  ref={footageRef}
                  src={asset('01-footage.mp4')}
                  poster={asset('01-footage-poster.jpg')}
                  onEnded={stopFootage}
                  muted
                  playsInline
                  preload="metadata"
        ...
        <aside className="profile-panel">
          ...
          <div className="profile-card">
            <div className="portrait-placeholder">
              <img src={asset('sources-a.png')} alt="A 인터뷰 인물 사진" />
            </div>
            <dl>
